...
{
  public:
    Vector3f v[3]; /*the original coordinates of the triangle, v0, v1, v2 in    顶点
                      counter clockwise order*/
    /*Per vertex values*/
    Vector3f color[3];      // color at each vertex; 颜色
    Vector2f tex_coords[3]; // texture u,v 材质
    Vector3f normal[3];     // normal vector for each vertex 法向量
    ...
    Eigen::Vector3f c() const { return v[2]; }//返回三角形顶点向量坐标
